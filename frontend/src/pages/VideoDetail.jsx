...
import { VideoPlayer, Videolist } from "../components/index.js";

function VideoDetail() {
  const { videoId } = useParams();

  const { data: video, isLoading, isError } = useVideoById(videoId);
  console.log(video, "Video Detail page");
  return (
    // <div>
          ...
          >
            ...
            <div class="h-5 overflow-hidden group-focus:h-auto">
              <p class="text-sm">
                ...
                &quot;Advanced React Patterns&quot;! 🛠️ Whether you&#x27;re a
                seasoned developer or just starting out, this series is designed
                to elevate your React skills to the next level.
              </p>
            </div>
          </div>
          {/* Comments */}
