...
const getChannelStats = asyncHandler(async (req, res) => {
    ...
    const totalSubscribers =await Subscripition.aggregate([
        {
            $match:{
    ...
    if(!totalSubscribers){
        throw new ApiError(500, "Error fetching total subscribers count");
    }
    ...
    if (!videoStats){
        throw new ApiError(500, "Error fetching video stats");
    }
    const channelStats = {
